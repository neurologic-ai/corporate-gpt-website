...
function EnterpriseModel(){return <section className="enterprise-model" id="enterprise-model"><div className="enterprise-model-copy" data-agency-reveal><p>OWN YOUR ENTERPRISE LLM</p><h2>A model built for<br/>one company. <em>Yours.</em></h2><span>Corporate GPT creates a custom model for your enterprise—distinct to your organization, controlled within your boundary, and built to become a lasting institutional asset.</span><strong>YOUR COMPANY · YOUR MODEL</strong></div><div className="enterprise-model-object" data-agency-reveal aria-hidden="true"><div className="enterprise-model-boundary"><span>YOUR ENTERPRISE BOUNDARY</span><div className="enterprise-model-field"><i/><i/><i/></div><div className="enterprise-model-plane plane-one"/><div className="enterprise-model-plane plane-two"/><div className="enterprise-model-plane plane-three"/><div className="enterprise-model-core"><small>ONE OF ONE</small><b>YOUR<br/>MODEL</b><em>DISTINCT · CONTROLLED · OWNED</em></div><p>YOUR COMPANY · YOUR MODEL</p></div></div></section>}
...
export function AgencyHome(){return <div className="agency-site"><AgencyMotion/><SiteHeader/><main id="main"><AgencyHero/><ClientProof/><ConnectorEcosystem/><EnterpriseModel/><AdaptiveIntelligence/><AssemblyStory/><ProductHorizontal/><CompoundingCapability/><UnlimitedTokens/><DeploymentRail/><AgencyCTA/></main><SiteFooter/></div>}
