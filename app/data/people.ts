...
export const leadershipProfiles: LeadershipProfile[] = [
  {
    ...
    bio: "Fifty-two years in technology. Founded and led TranSwitch Corporation from inception to a NASDAQ listing, bringing semiconductor, systems, and public-company operating depth.",
  ...
  },
  {
    ...
    name: "John Gillotte",
    role: "Co-Founder & CTO",
    bio: "Twenty-two years building production technology at scale, including early engineering experience at AWS S3 and Microsoft Research and later foundation-model architecture.",
  ...
  },
  {
    ...
    name: "Nishan Ali",
    role: "Founder & CEO",
    bio: "Twelve years in applied AI and enterprise transformation; M.Tech in AI from IIT Jodhpur and formerly UnitedHealth Group.",
